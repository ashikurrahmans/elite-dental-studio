...
const Sidebar = () => {
  return (
    <>
      <aside class="w-72 text-white" aria-label="Sidebar">
        <div class="px-3 py-4 overflow-y-auto rounded bg-gray-700 dark:bg-gray-800">
          <ul class="space-y-2">
            <li>
              <Link
                to="#"
              ...
              >
                ...
                <span class="ml-3 text-white hover:text-black">Dashboard</span>
              </Link>
            </li>
            <li>
              <a
