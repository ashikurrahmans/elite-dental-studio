...
import Keywords from "./shred/Keywords";
...
const SingleBlog = () => {
  ...
  const singleBlog = blog?.attributes;

  const imageUrl = singleBlog?.featureImage?.data?.attributes?.url;
  const originalImageLink = baseUrl + imageUrl;
              ...
              <div className="w-full px-10 lg:w-4/12">
                ...
                <div>
                  <div className="-mx-4 mb-8 flex flex-wrap my-4">
                    ...
                    <SidebarSingleArticle id={id}></SidebarSingleArticle>
                  </div>
                </div>
              </div>
            </div>
