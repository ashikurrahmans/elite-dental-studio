        ...
        <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
          ...
          <div className="md:max-w-md lg:col-span-2">
            ...
            <form className="flex flex-col mt-4 md:flex-row">
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide cursor-pointer text-black bg-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
              >
                Subscribe
              </button>
            </form>
            <p className="mt-4 text-sm text-gray-500">
              Subscribe for Don't missing Elite Dental Studio USA Updates.
            </p>
          </div>
        </div>
